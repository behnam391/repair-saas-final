...
export default function EnamadBadge({ className = "" }: { className?: string }) {
  ...
  return <div className={`flex justify-center ${className}`}><a referrerPolicy="origin" target="_blank" href={`https://trustseal.enamad.ir/?${query}`}><img src="/api/enamad-logo" alt="نماد اعتماد الکترونیکی پیوو" style={{ cursor: "pointer", width: 110, height: 120, objectFit: "contain" }} /></a></div>;
}
