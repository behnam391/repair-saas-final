...
type Ad = { id: string; imageUrl: string; linkUrl: string | null; active: boolean; sortOrder: number };
  ...
  return (
    <div className="min-h-screen p-4 max-w-md mx-auto">
      ...
      <div className="bg-surface border border-surface2 rounded-xl p-4 mb-6">
        ...
        <input className="w-full bg-surface2 rounded-lg px-3 py-2 text-sm mb-3" placeholder="لینک مقصد (اختیاری)"
      ...
      <div className="space-y-2">
        {ads.map((a) => (
          <div key={a.id} className="bg-surface2 border border-surface2 rounded-lg p-3 text-xs flex items-center gap-3">
            ...
            <div className="flex-1 truncate">{a.linkUrl || "بدون لینک"}</div>
